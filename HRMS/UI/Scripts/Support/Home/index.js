...
$(function () {
    ...
    var officeDS = new kendo.data.DataSource({
        transport: {
            batch: true,
            read: { url: '/api/SupportStaffShifts/GetOffices', dataType: 'json', type: 'GET' },
            create: { url: '/api/SupportStaffShifts/GetOffices', dataType: 'json', type: 'POST', contentType: 'application/json' },
            update: { url: '/api/SupportStaffShifts/GetOffices', dataType: 'json', type: 'PUT', contentType: 'application/json' },
            destroy: { url: '/api/SupportStaffShifts/GetOffices', dataType: 'json', type: 'DELETE', contentType: 'application/json' },
    ...
    function custom(e) {
        var date = kendo.toString(e.start, "d");
    }
