$(function () {
    ...
    // Employee Records Grid
        ...
        editable: "popup",
        height: 550,
        toolbar: [{ name: "create", text: "New Employee" }, { template: kendo.template($("#template").html())}],
        columns: [
            ...
            { command: ["edit", "destroy", { text: "View Details", click: showDetails }], attributes: { style: "text-align: center;" }, title: "Commands", width: "180px" }
        ]});
